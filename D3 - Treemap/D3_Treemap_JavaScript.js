...
//Aggregrate the values for the internal nodes. This is normally done by the 
//treemap layout
...
//Create the layout
// Defines hoe the nodes needs to be displayed in the svg
function layout (d){
	if (d.children){
...
// Add text for the child nodes
			k.append("foreignObject")
				...
				.attr("classs", function(d)  {
					if ((d.dy <= 25 && d.dx <=25) || (d.dy <= 25 && d.dx > 25) || (d.dy > 25 && d.dx <= 25))
